...
int main(void)
{
    ...
    PWM1_0_CTL_R &= (~1); //clearing
    PWM1_0_GENA_R = 0x8C; //PWM_0_GENA_ACTCMPAD_ZERO|PWM_0_GENA_ACTLOAD_M

    //generating
    PWM1_0_LOAD_R = 1250;       //31.25*40 = 1250-1 1249
    PWM1_0_CMPA_R = 625;        //for 50% duty cycle
    PWM1_0_CTL_R |= 0x1;        //PWM_0_CTL_ENABLE
    PWM1_ENABLE_R |= 0x1;        //PWM_ENABLE_PWM0EN
